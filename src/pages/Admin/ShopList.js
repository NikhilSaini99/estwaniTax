...
const ShopList = ({ checkss }) => {
    ...
    console.log('checking', loginStatus.adminLogin)


    if (!userList) {
        // Render a loading spinner or placeholder until the data is fetched
        return <CircularProgress sx={{ width: '100%', height: '100%', position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', background: 'white' }} />;
    }
            ...
            <Paper elevation={20} sx={{ width: '98%', mx: 'auto', my: '5rem', overflowX: 'auto', minHeight: 'calc(100vh - 120px)' }}>
                <Stack spacing={4} direction='column'>
                    <Box sx={{ display: 'flex', alignItems: 'center' }} >
                        <Typography variant='h1' sx={{ margin: '2.55rem auto', fontSize: '3rem', color: '#2C306F', }}>Pending Registration Requests</Typography>
